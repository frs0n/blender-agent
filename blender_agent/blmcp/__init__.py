...
"""
Blender Lab MCP reference package, embedded into Blender Agent.

The original package is an MCP server that talks to Blender through a bridge
server. In this project, the package is kept as a local source of prompt text,
tool schemas, bundled docs, and tool-code helpers for the embedded runtime.
"""
